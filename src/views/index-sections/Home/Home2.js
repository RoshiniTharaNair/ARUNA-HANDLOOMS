...
import explore2Image from "assets/img/Image (1)_11zon.png"; // Import the image
import explore3Image from "assets/img/IKATweb_11zon.webp"; // Import the image
  ...
  return (
    <div className="main-approach" >
      ...
      <Col className="approach-col d-flex align-items-center justify-content-center" lg={12} style={{ backgroundColor: "white", padding: "5% 0% 0% 0%" }}>
          ...
          margin: "0", padding: "0", letterSpacing:"0.1em" }}> 
          " Elegance woven in Every Thread "<br />
