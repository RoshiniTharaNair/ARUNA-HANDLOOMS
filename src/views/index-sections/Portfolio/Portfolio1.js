...
import yarnImage from "assets/img/Yarn Died1 (3).png"; // Import the image
import rotaryImage from "assets/img/Rotary4 (1).png"; // Import the image
import pintuckImage from "assets/img/pintucknew4.jpg.jpg"; // Import the image
import patchImage from "assets/img/patchnew3 (1).jpg"; // Import the image
import ikatImage from "assets/img/IKAT2.jpg"; // Import the image
import KnittedImage from "assets/img/Knitted 1.jpg"; // Import the image
import Kalamkari1Image from "assets/img/Kalamkari1.jpg"; // Import the image
import BAKITImage from "assets/img/BAKIT.jpg"; // Import the image
import GrayImage from "assets/img/gray1.jpeg"; // Import the image
...
Welcome to our portfolio. Here you’ll find a selection of our work. Explore our projects to learn more about what we do.</h1>
 ...
 <Card className="hover-card" onClick={()=>navigate('/batik')} data-text="BATIK FABRICS" style={{ borderRadius:"0px", height: '57%' }}>
     ...
     <Col className="col9-card" lg={4}  style={{}}>
 <Card className="hover-card" onClick={()=>navigate('/gray')} data-text="GRAY FABRICS" style={{ borderRadius:"0px", height: '57%' }}>
       <CardMedia 
        component="img"
        height="100%"
        width="100%" // Set the width to 100%
        image={GrayImage} // Use the imported image
      />
       </Card>
     </Col>
     {/* </Col>  */}
