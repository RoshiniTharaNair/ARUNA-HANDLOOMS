...
import yarnImage from "assets/img/patchnew1.jpeg"; // Import the image
import yarn2Image from "assets/img/Patch Work Fabrics2.jpg"; // Import the image
...
import yarn6Image from "assets/img/patchnew2.jpeg"; // Import the image
import yarn7Image from "assets/img/patchnew3.jpg"; // Import the image
...
<Col className="" lg={12} style={{height:"10%"}}>
    <img src={yarn7Image} alt="" style={{width:"80%",height:"auto"}} />
  ...
  <Row>
    <Col lg={4} style={{marginTop:"1%"}} >
      <img src={yarn6Image} alt="" style={{width:"100%",height:"80%"}} />
    </Col>
    <Col lg={4} style={{marginTop:"1%"}} >
      <img src={yarnImage} alt="" style={{width:"100%",height:"80%"}} />
    </Col>
    <Col lg={4} style={{marginTop:"1%"}} >
      <img src={yarn7Image} alt="" style={{width:"100%",height:"auto"}} />
    </Col>
  </Row>
</Container>
  <Container>
